...
export const DisplayTrack = ({currentTrack, setDuration, progressBarRef, audioRef}) => {
  ...
  return (
    <div>
      <audio src={currentTrack.src} ref={audioRef} onLoadedMetadata={onLoadedMetadata} onEnded={h}/>
